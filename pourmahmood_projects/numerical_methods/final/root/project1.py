    ...
    while True:
        try:
            ...
            if choice == "1":
                ...
                if not root_input:
                    return None
                input_expr = parse_expr(root_input)
                true_root = lambdify(symbols("x"), input_expr, "math")(0)
...
if __name__ == "__main__":
    # Interactive setup
    use_interactive = input("Use interactive setup? (y/n, default=y): ").strip().lower()
    
    if use_interactive not in ["n", "no"]:

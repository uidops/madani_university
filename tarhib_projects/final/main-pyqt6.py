...
class MainWindow:
    ...
    def setup_ui(self):
        ...
        self.feedProgressBar.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.actionNew_RSS_Feed = QtGui.QAction(self.MainWindow)
    ...
    def del_rss(self):
        ...
        if len(self.data) and len(self.rss.urls):
